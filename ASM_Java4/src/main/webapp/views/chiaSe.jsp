				...
				<div class="col-md-4">
					<form " method="post">
						...
						<a href="/ASM_Java4/index">
							<button formaction="/ASM_Java4/chiaSeMail/${video.maVideo} type="button" class="cancelbtn">Trang chủ</button>
							</a>
							
					</form>
				</div>
				<div class="col-md-8" style="padding-top: 30px">
					<img src="${video.poster}" alt="" style="border-radius: 10px" width="80%">
					<h3 >${video.chuDe}</h3>
				</div>
			</div>
		</center>
