        ...
        <div class="video-overlay header-text">
            <div class="caption" style="text-align: left;width: 40%;">
                <form method="post">
                    <div class="row">
                        <center>
                        <h3>NHẬN MÃ BẢO MẬT </h3>                           
                        </center>
                        <hr>
                        <label for="uname"><b>Số điện thọai</b></label>
                            <input class="ip" type="text" placeholder="Số điện thoại?" name="sdt" required value="${user.sdt}">
                            <label for="uname"><b>Email đăng kí</b></label>
                            <input class="ip" type="email" placeholder="Email?" name="email" required>                       
                    </div>
                    <center>
                    		${message}
                        <button formaction="/ASM_Java4/QuenMk/nhanMa" class="lgin" type="submit">Nhận mã</button>
                    </center>
